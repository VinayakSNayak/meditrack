...
Future<void> main() async {
  ...
  // Notifications (channel + permission setup only — no scheduling here).
  // Scheduling happens in SplashScreen AFTER login, when uid + memberId
  // are available. Doing it here causes a silent failure (user not logged in).
